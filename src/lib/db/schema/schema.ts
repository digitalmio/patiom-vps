...
export const schemaTypes = pgTable("schema_types", {
...
export const schemaTypesIndexes = {
	schemaVersionIdx: index("idx_schema_types_version").on(
		schemaTypes.schemaVersionId,
	),
	projectIdx: index("idx_schema_types_project").on(schemaTypes.projectId),
};
...
export const schemaFieldsIndexes = {
	schemaVersionIdx: index("idx_schema_fields_version").on(
		schemaFields.schemaVersionId,
	),
	projectIdx: index("idx_schema_fields_project").on(schemaFields.projectId),
	fieldPathIdx: index("idx_schema_fields_path").on(schemaFields.fieldPath),
};
